...
class Matrix(Array2D):
    ...
    # Finds and returns the determinant of 2*2 or 3*3 matrix
    def det(self):
    ...
    # Finds and returns the inverse of 2*2 matrix
    def inverse(self):
...
print('Determinant of C is :',C.det())

# Finds the inverse of matrix A
print('Inverse of A is : \n',A.inverse())

# The method can't find the inverse of matrix C, it's a 3*3 matrix
print('Inverse of C is : \n',C.inverse())

# B is 2*3 Matrix
B = Matrix(2,3)

# The method can't find the determinant and inverse of matrix B
print('Determinant of B is :',B.det())
